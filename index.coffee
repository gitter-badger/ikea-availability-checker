...
db.serialize ->
  ...
  stmt.run '20205897', 'KROKTORP Tür elfenbeinweiss'
  stmt.run '20205915', 'KROKTORP Tür elfenbeinweiss'
  stmt.run '40212444', 'KROKTORP Tür elfenbeinweiss'
  stmt.run '90205912', 'KROKTORP Schubladenfront elfenbeinweiss'
  stmt.run '60205918', 'KROKTORP Schubladenfront elfenbeinweiss'
  stmt.finalize()

  db.each "SELECT id, name FROM product", (err, row) ->
    console.log err
